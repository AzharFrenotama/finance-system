...
class AuthController extends Controller
{
     ...
     * Register.
     *
     * @bodyParam name string required Nama pengguna. Contoh: Raja Kumara
    ...
    * @bodyParam description string required The description.
    * @bodyParam price float required The price.
    *
    * @response 201 {
    *   "id": 1,
    *   "name": "Product 1"
